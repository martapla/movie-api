      ...
      <>
        ...
        <form className='flex items-center justify-center'>
            <div className="bg-gray-900 border border-2 border-gray-300 py-6 rounded-md px-4 md:px-10  shadow-md">
               ...
               <button className="w-full mt-5 bg-gray-900 text-zinc-400 py-2 border border-2 border-zinc-400 rounded-md hover:text-yellow-500 hover:border-yellow-500 cursor-pointer">Log In</button>
            </div>
